          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-slate-400">Normal Agent</span>
              </div>
            </div>
            <button 
              className="md:hidden p-2 rounded-lg bg-slate-700/50 hover:bg-slate-600 transition-colors"
              onClick={() => setIsOpen(false)}
            >
        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-2">
            ...
            <ul className="space-y-1">
              ...
              >
                <img
                  ...
                  alt="AirtelTigo"
                />
                <span className="font-medium">AIRTEL TIGO</span>
              </li>
            </ul>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="space-y-1">
              ...
              <div onClick={() => setIsOpen(false)} className="rounded-xl overflow-hidden">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li
                className="flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer text-slate-300 hover:bg-slate-700/50 hover:text-white transition-all duration-200"
                onClick={() => {
                  navigate("/profile");
                  setIsOpen(false);
                }}
              ...
              <li
                className="flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer text-red-400 hover:bg-red-500/20 hover:text-red-300 transition-all duration-200"
                onClick={logoutUser}
              >
        ...
        <header className="bg-white/80 backdrop-blur-lg border-b border-slate-200 sticky top-0 z-30">
          ...
          <div className="md:hidden p-4">
            <div className="flex items-center justify-between mb-3">
              <button 
                className="p-2.5 rounded-xl bg-slate-900 text-white shadow-lg hover:bg-slate-800 transition-all" 
              ...
              <div className="flex items-center gap-2">
                <AgentNotifications />
                <button
                  className="relative p-2.5 rounded-xl bg-gradient-to-r from-sky-500 to-sky-600 text-white shadow-lg hover:shadow-xl transition-all"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">
                    GHS {parseFloat(Math.abs(loanBalance?.loanBalance || 0)).toFixed(2)}
                  </p>
                  {loanBalance?.hasLoan && (
                    <p className="text-xs text-red-400 mt-1 animate-pulse">
                      Loan: GHS {parseFloat(loanBalance?.adminLoanBalance || 0).toFixed(2)}
                    </p>
                  )}
                </div>
                <button
                  className="px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white text-sm font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all"
          ...
          <div className="hidden md:flex lg:hidden p-4 items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <AgentNotifications />
              <button
                className="px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all"
                onClick={() => setTopUp(true)}
              >
                Top Up
              </button>
              <button
                className="flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium rounded-xl transition-all"
                onClick={() => setIsHistoryOpen(true)}
              >
                <History className="w-4 h-4" />
                <span>History</span>
              ...
              <button
                className="relative p-2.5 rounded-xl bg-gradient-to-r from-sky-500 to-sky-600 text-white shadow-md hover:shadow-lg transition-all"
                onClick={() => setIsCartOpen(true)}
              >
                <ShoppingCart className="w-5 h-5" />
                {cart.length > 0 && (
          ...
          {/* Desktop Header (lg screens and up) */}
          <div className="hidden lg:flex p-4 items-center justify-between">
              ...
              {loanBalance?.hasLoan && (
                <div className="px-3 py-1.5 bg-red-50 border border-red-200 rounded-lg">
                  <p className="text-sm text-red-600 font-medium animate-pulse">
                    Loan Balance: GHS {parseFloat(loanBalance?.adminLoanBalance || 0).toFixed(2)}
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl px-5 py-3 shadow-lg">
                ...
                <button
                  className="px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-semibold rounded-xl shadow-md hover:shadow-lg hover:scale-105 transition-all"
                  onClick={() => setTopUp(true)}
                >
                  Top Up
                </button>
              ...
              {/* Order History */}
              <button
                className="flex items-center gap-2 px-4 py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium rounded-xl transition-all"
                onClick={() => setIsHistoryOpen(true)}
              >
              ...
              {/* Shopping Cart */}
              <button
                className="relative p-3 rounded-xl bg-gradient-to-r from-sky-500 to-sky-600 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all"
                onClick={() => setIsCartOpen(true)}
              >
          ...
          loading ? (
            ...
            <main className="flex-1 overflow-y-auto bg-gradient-to-br from-slate-50 to-slate-100 p-4 md:p-6 lg:p-8">
              ...
              <div className="mb-6 md:mb-8">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  ...
                  <div className="flex flex-wrap gap-2 md:hidden">
                    ...
                    <button
                      onClick={() => handleCategorySelect("MTN")}
                      className={`px-3 py-1.5 rounded-full text-sm font-medium transition-all ${
                        selectedCategory === "MTN"
                    ...
                    <button
                      onClick={() => handleCategorySelect("TELECEL")}
                      className={`px-3 py-1.5 rounded-full text-sm font-medium transition-all ${
                        selectedCategory === "TELECEL"
                    ...
                    <button
                      onClick={() => handleCategorySelect("AIRTEL TIGO")}
                      className={`px-3 py-1.5 rounded-full text-sm font-medium transition-all ${
                        selectedCategory === "AIRTEL TIGO"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
                {filteredProducts1
                  ?.filter((product) =>
                    userRole === "NORMAL" ? product.name.includes("NORMAL") : true
                  )
                  .sort((a, b) => {
                        ...
                        <div className="p-4 md:p-5">
                          ...
                          <div className="space-y-2">
                            <input
                              ...
                              } rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-0 transition-all`}
                              maxLength={10}
                            />
                            {error[product.id] && (
                          ...
                          <motion.button
                            ...
                            whileHover={{
                              scale: loanBalance?.loanBalance > 0 && product.stock > 0 ? 1.02 : 1,
                            }}
                            whileTap={{
                              scale: loanBalance?.loanBalance > 0 && product.stock > 0 ? 0.98 : 1,
                            }}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">{cart.length} item{cart.length !== 1 ? 's' : ''}</p>
                  </div>
                </div>
                <button
                  ...
                  {cart.map((item, index) => (
                    ...
                    >
                      ...
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                        item.product.name.includes("MTN") ? "bg-yellow-100" :
                        item.product.name.includes("TELECEL") ? "bg-red-100" :
                        item.product.name.includes("AIRTEL") ? "bg-blue-100" : "bg-slate-100"
                      }`}>
                        <span className="text-lg font-bold">
                          {item.product.name.includes("MTN") ? "M" :
                           item.product.name.includes("TELECEL") ? "T" :
                           item.product.name.includes("AIRTEL") ? "A" : "?"}
                        </span>
                      </div>
              ...
              <div className="border-t border-slate-200 p-6 bg-slate-50">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-2xl font-bold text-slate-900">
                    GHS {cart.reduce((total, item) => total + item.product.price * (item.quantity || 1), 0).toFixed(2)}
                  </span>
                </div>
                ...
                <div className="flex gap-3">
                  <button
                    className="flex-1 px-4 py-3 bg-slate-200 hover:bg-slate-300 text-slate-700 font-semibold rounded-xl transition-colors disabled:opacity-50"
                    onClick={clearCart}
                  ...
                  <button
                    className="flex-1 px-4 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
