          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-amber-400">Premium Agent</span>
              </div>
            </div>
        ...
        <header className="bg-white/80 backdrop-blur-lg border-b border-slate-200 sticky top-0 z-30">
          ...
          <div className="md:hidden p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-2">
                <AgentNotifications />
                <button className="relative p-2.5 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 text-white shadow-lg hover:shadow-xl transition-all" onClick={() => setIsCartOpen(true)}>
          ...
          <div className="hidden md:flex lg:hidden p-4 items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="relative p-2.5 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 text-white shadow-md hover:shadow-lg transition-all" onClick={() => setIsCartOpen(true)}>
                <ShoppingCart className="w-5 h-5" />
          ...
          <div className="hidden lg:flex p-4 items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="relative p-3 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all" onClick={() => setIsCartOpen(true)}>
        ...
        {userRole === "PREMIUM" ? (
          loading ? (
            ...
            <main className="flex-1 overflow-y-auto bg-gradient-to-br from-slate-50 to-slate-100 p-4 md:p-6 lg:p-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div>
                    <h2 className="text-2xl md:text-3xl font-bold text-slate-900">
                      {selectedCategory ? `${selectedCategory} Products` : "Premium Products"}
                    </h2>
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-full text-sm font-medium transition-all ${
                          (cat === "All" && selectedCategory === null) || selectedCategory === cat
                            ? cat === "MTN" ? "bg-yellow-500 text-white" : cat === "TELECEL" ? "bg-red-500 text-white" : cat === "AIRTEL TIGO" ? "bg-blue-500 text-white" : "bg-amber-500 text-white"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
                {filteredProducts1
                  ?.filter((product) => userRole === "PREMIUM" ? product.name.includes("PREMIUM") : true)
                  .sort((a, b) => {
          ...
          <div className="flex-1 flex justify-center items-center bg-gradient-to-br from-slate-50 to-slate-100">
            <div className="text-center p-8">
              ...
              <p className="text-slate-500">Only Premium users can view these products.</p>
            </div>
          </div>
        )}
      </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-100">{cart.length} item{cart.length !== 1 ? 's' : ''}</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  {cart.map((item, index) => (
                    <motion.div key={index} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl hover:bg-slate-100 transition-colors">
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${item.product.name.includes("MTN") ? "bg-yellow-100" : item.product.name.includes("TELECEL") ? "bg-red-100" : item.product.name.includes("AIRTEL") ? "bg-blue-100" : "bg-amber-100"}`}>
                        <span className="text-lg font-bold">{item.product.name.includes("MTN") ? "M" : item.product.name.includes("TELECEL") ? "T" : item.product.name.includes("AIRTEL") ? "A" : "P"}</span>
                      </div>
